<template>
  <a
    v-if="link"
    :class="['m-nav-link', isTrip ? '' : 'disbale']"
    :href="link"
    rel="noreferrer"
  >
    <article class="box">
      <div class="box-header">
        ...
        <img v-if="isTrip" src="../images/icon/collectHight.png" width="30" height="30" />
        <img v-else src="../images/icon/collect.png" alt="" srcset="" width="30" height="30" />
      </div>
